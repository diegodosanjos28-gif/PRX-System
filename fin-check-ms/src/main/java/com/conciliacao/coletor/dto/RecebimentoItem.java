...
/**
 * Cada elemento do array "result" de POST /recebimentos-operadoras/buscar.
 * Campos UPPER_CASE conforme API real.
 * ATENÇÃO: valorBruto e valorLiquido são NEGATIVOS em Ajuste a Débito (COD_TIPO_LANCAMENTO="2").
 * Campos null aceitos sem exceção (o ObjectMapper ignora propriedades desconhecidas).
 * Campo CARTAO não deve aparecer em logs (número mascarado, mas ainda sensível).
 */
