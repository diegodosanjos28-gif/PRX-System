...
@Table(name = "recebimentos",
    uniqueConstraints = @UniqueConstraint(
        name = "uq_rec_id_conciflex_estabelecimento",
...
public class Recebimento {
    ...
    // Número mascarado do cartão — nunca deve aparecer em logs
    @Column(name = "cartao")
    ...
    // NEGATIVO em ajustes a débito (cod_tipo_lancamento = "2")
